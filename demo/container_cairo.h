...
struct cairo_clip_box {
    ...
    cairo_clip_box(const litehtml::position &vBox,
                   const litehtml::border_radiuses &vRad) {
        box = vBox;
        radius = vRad;
    }
...
class container_cairo : public litehtml::document_container {
  ...
  public:
    ...
    virtual void make_url(const char *url, const char *basepath,
                          litehtml::string &out);
  ...
  protected:
    ...
    virtual void fill_ellipse(cairo_t *cr, int x, int y, int width, int height,
                              const litehtml::web_color &color);
    virtual void rounded_rectangle(cairo_t *cr, const litehtml::position &pos,
  ...
  private:
    ...
    static void draw_pixbuf(cairo_t *cr, cairo_surface_t *bmp, int x, int y,
                            int cx, int cy);
